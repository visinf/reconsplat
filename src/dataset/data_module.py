...
class DataLoaderStageCfg:
    ...
    seed: int | None
    prefetch_factor: int | None = None  # batches held per worker; None = PyTorch's default (2).
...
class DataModule(LightningDataModule):
    ...
    def get_prefetch_factor(self, loader_cfg: DataLoaderStageCfg) -> int | None:
        # DataLoader raises if prefetch_factor is set while num_workers == 0 (no workers to prefetch on).
    ...
    def train_dataloader(self):
        ...
        return DataLoader(
            ...
            prefetch_factor=self.get_prefetch_factor(self.data_loader_cfg.train),
            pin_memory=True,
        )
    ...
    def val_dataloader(self):
        ...
        return DataLoader(
            ...
            prefetch_factor=self.get_prefetch_factor(self.data_loader_cfg.val),
            pin_memory=True,
        )
    ...
    def test_dataloader(self, dataset_cfg=None):
        ...
        return DataLoader(
            ...
            prefetch_factor=self.get_prefetch_factor(self.data_loader_cfg.test),
            shuffle=False,
            pin_memory=True,
        )
